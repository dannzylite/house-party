...
def update_or_create_tokens(session_id, access_token, refresh_token, token_type, expires_in):
    ...
    if token:
        ...
        token.save(update_fields=['access_token', 'token_type', 'expires_in'])
        
    
    else:
        token = SpotifyToken(user=session_id, access_token=access_token, refresh_token=refresh_token, token_type=token_type,
...
def refresh_spotify_token(session_id):
    ...
    update_or_create_tokens(session_id, access_token, refresh_token, token_type, expires_in)
